...
const TicketFilterForm = ({ onClose, onApplyFilters }) => {
  // Accept onApplyFilters as a prop
  ...
  const handleApplyFilters = () => {
    ...
    onApplyFilters(activeFilters); // Send filters to TicketTable
    handleClose();
  };
  ...
  return (
    ...
    >
      <div
        className={`bg-[#EDEDED] w-[400px] h-full shadow-lg p-6 transform transition-transform duration-300 ${
...
TicketFilterForm.propTypes = {
  ...
  onApplyFilters: PropTypes.func.isRequired, // Added PropType
};
